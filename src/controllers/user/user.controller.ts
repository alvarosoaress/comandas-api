...
import { type userLoginType, type createUserType, type getUserByIdType } from '../../schema/user.schema';
...
export async function getUserById (req: Request<getUserByIdType>, res: Response) {
  const { id } = req.params;
